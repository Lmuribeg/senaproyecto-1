...
<body class="fondo1">
  ...
  <div class="row justify-content-center form-group">
    ...
    <div class=" form-group">
      <h4 class="R">Editar seccion 1</h4>
    <label for="exampleInputPassword1">Ingrese su nuevo logo</label><br>
    <input type="file" name="logo" value="<?php echo $row["logo"];?>" class="form-control" id="exampleInputPassword1" placeholder="nombre">
  </div>
